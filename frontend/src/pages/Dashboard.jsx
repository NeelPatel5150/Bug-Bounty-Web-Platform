...
import { NeoCard, NeoBadge, NeoSecondaryButton } from '../components/NeoBrutalist';
            ...
            <div className="border-b-2 border-black bg-white pb-16 pt-12 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-6">
                        Find Bugs.{' '}
                        <span className="bg-black text-white px-2 transform -rotate-1 inline-block">
                            Get Paid.
                        </span>
                    </h1>
                        ...
                        return (
                            ...
                            >
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    {/* Bounty Amount */}
                                    <span className="text-lg font-black bg-blue-500 text-white px-3 py-1 transform rotate-2 shadow-[2px_2px_0_#000]">
                                        ${bug.bountyAmount}
                                    </span>
                                </div>
                                ...
                                <h3 className="text-2xl font-black uppercase mb-3 line-clamp-2 leading-tight">
                                    <Link
                                        to={`/bug/${bug._id}`}
                                        className="hover:underline decoration-4 decoration-[#d4561c]"
                                    >
                                        {bug.title}
                                    </Link>
                                </h3>
